...
import 'package:flutter_test_coffe_app2/pages/navigation/case1/Case1Page.dart';
...
import 'package:flutter_test_coffe_app2/pages/navigation/case5/Case5Page.dart';
...
class NavigationPage extends StatelessWidget {
  ...
  _buildButtons(BuildContext context) =>
      Column(children: <Widget>[
        ...
        buildButton(context, label: "Use case 1", routeTo: new AScreen(),routName: "/A"),
        ...
        buildButton(context, label: "Use case 5", routeTo: new Case5Page()),
